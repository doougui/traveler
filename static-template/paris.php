			...
			<div id="carousel-paris" class="carousel slide" data-ride="carousel">
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img class="d-block w-100" src="assets/img/paris/paris1.jpg" alt="Paris">
			    </div>
			    <div class="carousel-item">
			      <img class="d-block w-100" src="assets/img/paris/paris2.jpg" alt="Paris">
			    </div>
			    <div class="carousel-item">
			      <img class="d-block w-100" src="assets/img/paris/paris3.jpg" alt="Paris">
			    </div>
			  </div>
